...
public class IWItems {
    ...
    public static final RegistrySupplier<Item> AR_57_GUN = register("ar_57", () -> new GunItem(IWGuns.AR_57, new Item.Properties()));
    public static final RegistrySupplier<Item> PKP_GUN = register("pkp", () -> new GunItem(IWGuns.PKP, new Item.Properties()));
